...
<head>
    ...
    <!--[if lt IE 10]>
      ...
      <!-- ico font -->
      <link rel="stylesheet" type="text/css" href="{{ asset('backview/assets/icon/icofont/css/icofont.css') }}">
      <!-- Font Awesome -->
      <link rel="stylesheet" type="text/css" href="{{ asset('backview/assets/icon/font-awesome/css/font-awesome.min.css') }}">
      <!-- Style.css -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action="{{ route('signin') }}" method="POST">
                            @csrf
                            <div class="text-center">
                                <img src="{{ asset('backview/assets/images/logo.png') }}" alt="logo.png">
                            </div>
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="button" id="loginButton" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Sign in</button>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="row">
                                        <div class="col-md-10">
                                            <p class="text-inverse text-left m-b-0">SMALL-ITS</p>
                                            <p class="text-inverse text-left"><a href="index.html"><b>PPS Kelompok 4</b></a></p>
                                        </div>
                                        <div class="col-md-2">
                                            <img src="{{ asset('backview/assets/images/auth/Logo-small-bottom.png') }}" alt="small-logo.png">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript" src="{{ asset('backview/assets/js/common-pages.js') }}"></script>
<script>
